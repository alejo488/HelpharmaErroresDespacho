using ErrorDespacho.Constant.P2hConstant;
...
namespace ErrorDespacho.Services.P2HServices
{
    public class P2hService
    {
        ...
        public async Task<TResponse?> SendDespachoAsync<TResponse>(PayloadDto payload)
        {
            var request = new P2hRequest<PayloadDto>
            {
                Payload = payload
            };
